        ...
        <div :class="data.id ? 'col-md-7' : 'col-md-12'">
          ...
          <div class="col-md-6">
            <fg-input
              class="clean"
              type="text"
              label="Registro Siape"
              placeholder=""
              v-model="data.siapeRegistration"
              v-bind:readonly="readonly"
            />
          </div>
          ...
          <div class="col-md-6">
            <label class="stronger" style="margin: 0px !important">
              Ativo?
            </label>
            <br />
            <button
