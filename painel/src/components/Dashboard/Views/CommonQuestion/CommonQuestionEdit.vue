...
<script>
import CommonQuestionForm from "src/components/UIComponents/Forms/CommonQuestionForm.vue";
...
export default {
  ...
  methods: {
    ...mapActions(["updateCommonQuestion", "getCommonQuestion"]),
    ...mapGetters({
  ...
  created() {
    ...
    this.$on("save", () => {
        this.updateCommonQuestion(this.data)
            .then(res => {
               this.$notify({
                group: "foo",
                title: "Sucesso",
